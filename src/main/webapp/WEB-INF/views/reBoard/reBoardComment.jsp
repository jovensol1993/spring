...
<body>
	<div class="w3-content mw700">
		<h1 class="w3-color-purple w3-center mb10 w3-padding">댓글 작성</h1>
		<div class="w3-col">
			...
			<form method="POST" action="/cls/reBoard/reBoardCommentProc.cls" class="w3-rest" id="frm" name="frm">
				...
				<textarea class="w3-input w3-border h72" style="resize: none;"
					placeholder="메세지를 작성하세요!" id="body" name="body"></textarea>
				<div class="w3-col pdh1 mt5">
					...
					<span class="w3-col m2 w3-right w3-button w3-small w3-pink w3-hover-purple btn" id="wrbtn">댓글 등록</span>
				</div>
			</form>
		</div>
	</div>
